...
//         const updatedForms = [...forms];
//         updatedForms[formIndex].fields.push({ fieldId: '' });
//         setForms(updatedForms);
//     };
...
//             if (form._id) {
//                 await doPUT(FORMENDPOINTS.updateForm(form._id), { ...form, project: projectId });
//             } else {
//                 await doPOST(FORMENDPOINTS.addForm, { ...form, project: projectId });
//             }
//         } catch (error) {
...
const EditProject = () => {
    ...
    const handleFormSubmit = async (formIndex, projectId) => {
        try {
            const form = forms[formIndex];
            const fields = form.fields.map(field => field.fieldId);
            if (form._id) {
